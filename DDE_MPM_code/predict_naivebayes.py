...
def predict_naivebayes(data_all, output_dir, result_dir, w_p2n=100, *args, **kwargs):
...
if __name__ == '__main__':
    ...
    out = predict_naivebayes(sample, output_dir,result_dir,w_p2n=w_p2n,priors = priors)
    ...
    photo(x,y,score,output_dir_png,'NaiveBayes')
