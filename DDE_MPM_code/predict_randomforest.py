...
def predict_randomforest(data_all, output_dir, result_dir, w_p2n=100, *args, **kwargs):
...
if __name__ == '__main__':
    ...
    out = predict_randomforest(sample, output_dir,result_dir,w_p2n=w_p2n,max_depth = max_depth,min_impurity_decrease = min_impurity_decrease, n_estimators=n_estimators)
    ...
    photo(x,y,score,output_dir_png,'RandomForest')
