...
def predict_adaboost(data_all, output_dir, result_dir, w_p2n=100, *args, **kwargs):
...
if __name__ == '__main__':
    ...
    out = predict_adaboost(sample, output_dir,result_dir,w_p2n=w_p2n,n_estimators = n_estimators,learning_rate = learning_rate)
    ...
    photo(x,y,score,output_dir_png,'Adaboost')
