...
def predict_svm(data_all, output_dir, result_dir, w_p2n=100, *args, **kwargs):
...
if __name__ == '__main__':
    ...
    output_dir_png = sys.argv[8]
    output_dir_tif = sys.argv[9]
    ...
    out = predict_svm(sample, output_dir,result_dir,w_p2n=w_p2n,C = C,kernel = kernel, gamma = gamma)
    ...
    photo(x,y,score,output_dir_png,'SVM')