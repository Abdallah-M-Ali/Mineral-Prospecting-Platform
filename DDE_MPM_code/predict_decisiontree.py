...
def predict_decisiontree(data_all, output_dir, result_dir, w_p2n=100, *args, **kwargs):
...
if __name__ == '__main__':
    ...
    out = predict_decisiontree(sample, output_dir,result_dir,w_p2n=w_p2n,max_depth = max_depth,criterion = criterion)
    ...
    photo(x,y,score,output_dir_png,'Decision tree')
