...
def pca_plot(img, pca, indexer_T, indexer_F, dimension, n_components, output_path_npy_list, output_path_plot_pca,
             output_path_tif_list, mask_path):
	del img['Mask']
...
if __name__ == '__main__':
	...
	pca_plot(img, pca, indexer_T, indexer_F, dimension, n_components, output_path_npy_list, output_path_plot_pca,
	         output_path_tif_list, mask_path)
